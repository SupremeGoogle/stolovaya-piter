    ...
    if (text === '/stolovaya062026') {
      ...
      if (!exists) {
        ...
        await sendTelegramMessage(
          ...
          `Теперь вы будете получать уведомления о новых заявках с сайта «Столовая Шушары».`
        );
      ...
      await sendTelegramMessage(
        `👋 Приветствую! Это бот уведомлений для «Столовой» (г. Санкт-Петербург, пос. Шушары).\n\n` +
